<?php
	...
	function login($tablename, $userID_colName, $userPwd_colName, $username, $password){
		if(checkDataExistance($tablename, array($userID_colName), array($username))){
			$db_password = getValue($tablename, $userPwd_colName, $userID_colName, $username);
			...
			return "Wrong Username, Access Denied!";
		}
	}
